...
cp /data/data/com.guoshi.httpcanary.premium/cache/HttpCanary.p12 /data/local/tmp/HttpCanary-protected.p12
$MODPATH/common/openssl pkcs12 -in /data/data/com.guoshi.httpcanary.premium/cache/HttpCanary.p12 -passin pass:HttpCanary -nodes -out /data/local/tmp/temp.pem
...
# Mandatory file
toch /data/data/com.guoshi.httpcanary.premium/cache/HttpCanary.jks

# Copy pem for Magisk to mount
mkdir -p $MODPATH/system/etc/security/cacerts
cp /data/data/com.guoshi.httpcanary.premium/cache/HttpCanary.pem $MODPATH/system/etc/security/cacerts/87bc3517.0
